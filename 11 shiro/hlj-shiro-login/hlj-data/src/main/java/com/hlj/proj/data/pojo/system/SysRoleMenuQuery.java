...
/**
 * @author zhangyujin
 * @ClassName: SysRoleMenuQuery
 * @date 2099/1/1
 * @Description: SysRoleMenuQuery
 */
@Data
public class SysRoleMenuQuery extends PagingQuery {
	...
	public SysRoleMenuQuery(int pageNo, int pageSize){
